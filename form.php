...
<h1 class="titulo">Obrigado! A sua mensagem foi registada!</h1>

<?php

$filename = 'form.txt';

$firstname = "Nome: ".$_POST['firstname'];
$lastname = "Apelido: ".$_POST['lastname'];
$email = "Email: ".$_POST['email'];
$message = "Mensagem: ".$_POST['mensagem'];

$write = $firstname . '<br>' . $lastname . '<br>' . $email . '<br>' . $message . '<br>' . '<br>';

file_put_contents($filename, $write, FILE_APPEND);
?>

<a class="subtitulo" href="pages/como-visitar.html"><p>Voltar atrás</p></a>
</div>
